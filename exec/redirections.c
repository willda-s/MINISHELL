...
/*   Updated: 2025/09/29 21:13:02 by akarapkh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	open_redir_in(t_exec *node, t_data *data, const char *filename);
static int	open_redir_trunc(t_exec *node, t_data *data, const char *filename);
static int	open_redir_append(t_exec *node, t_data *data, const char *filename);
static int	open_heredoc_in(t_exec *node, t_data *data, const char *filename);
